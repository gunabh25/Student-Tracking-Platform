    ...
    <div className="w-full">
      <div className="flex justify-between items-center py-4">
        ...
        {/* <DropdownMenu>
            ...
            <DropdownMenuContent>
              <DropdownMenuCheckboxItem>1st </DropdownMenuCheckboxItem>
              <DropdownMenuCheckboxItem>2nd</DropdownMenuCheckboxItem>{" "}
              <DropdownMenuCheckboxItem>3rd</DropdownMenuCheckboxItem>{" "}
              <DropdownMenuCheckboxItem>4th</DropdownMenuCheckboxItem>
            </DropdownMenuContent>
          </DropdownMenu>    <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button variant="outline" className="">
                Filter by section <ChevronDown className="ml-2 h-4 w-4" />
              </Button>
            </DropdownMenuTrigger>
            <DropdownMenuContent>
              <DropdownMenuCheckboxItem>A </DropdownMenuCheckboxItem>
          ...
          <Input
            ...
            value={
              table.getColumn(columns[1].accessorKey)?.getFilterValue() ?? ""
            }
            onChange={(event) =>
              table
